...
/** Maps each tuple field index to a new tuple field index.  The map is indexed with a
 * field in the represented type, and gives a field in the compressed type. */
