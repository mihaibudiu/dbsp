...
public class DBSPComparatorType extends DBSPTypeUser {
    ...
    static String generateName(
            ...
            int field, boolean ascending, NullCollation nullCollation) {
        return MerkleInner.hash(comparator.name + "." + field + " " + ascending + " " + nullCollation)
                .makeIdentifier("CMP");
    }

    public static DBSPComparatorType
    generateType(DBSPComparatorType type, int field, boolean ascending, NullCollation nullCollation) {
        return new DBSPComparatorType(generateName(type, field, ascending, nullCollation));
    }
